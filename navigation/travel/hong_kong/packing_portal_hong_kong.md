...
<body>
    <div class="container">
        <!-- Main Content -->
        <div class="main">
            <h1>Packing Portal: Hong Kong</h1>
            <div class="packing-items">
                <div class="packing-item">
                    <input type="checkbox" id="packing-item">
                    <label for="packing-item">Lightweight clothing</label><br>
                </div>
                <div class="packing-item">
                    <input type="checkbox" id="packing-item">
                    <label for="packing-item">Waterproof Shoes</label><br>
                </div>
                <div class="packing-item">
                    <input type="checkbox" id="packing-item">
                ...
                <div class="packing-item">
                    <input type="checkbox" id="packing-item">
                    <label for="packing-item">Small Umbrella</label><br>
                </div>
                <div class="packing-item">
                    <input type="checkbox" id="packing-item">
                ...
                <div class="packing-item">
                    <input type="checkbox" id="packing-item">
                    <label for="packing-item">Portable Fan</label><br>
                </div>
                <div class="packing-item">
                    <input type="checkbox" id="packing-item">
                    <label for="packing-item">Sunscreen</label><br>
                </div>
                <div class="packing-item">
                    <input type="checkbox" id="packing-item">
