...
- A-Type In AWS Website means mapping to spefic IP adress
- Name Service = godaddy
- nginx is listener to the internet anmd takes the server name and maps to running app on macjine
- yaml file REQUIRES .env file and OUTSIDE VENV (avoids loss of data)
...
DEFAULT_USER='kiruthic'
DEFAULT_PASSWORD='123Kiruthic!'
DEFAULT_USER='tarun'
DEFAULT_PASSWORD='123Tarun!'
DEFAULT_USER='rohan'
DEFAULT_PASSWORD='123Rohan!'
DEFAULT_USER='arhaan'
DEFAULT_PASSWORD='123Arhaan!'
DEFAULT_USER='aadi'
DEFAULT_PASSWORD='123Aadi!'
DEFAULT_USER='derek'
DEFAULT_PASSWORD='123Derek!'
DEFAULT_USER='aaditya'
DEFAULT_PASSWORD='123Aaditya!'
```
